...
class AddCostPerFloorAreaToUnusedLights_Test < Test::Unit::TestCase
  
  
  def test_AddCostPerFloorAreaToUnusedLights_fail
     
    # create an instance of the measure
    measure = AddCostPerFloorAreaToUnusedLights.new
  ...
  def test_AddCostPerFloorAreaToUnusedLights_good
    ...
    assert(lights_def.setValue("Unused Light LPD"))
